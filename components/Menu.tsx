...
const FeaturedItemPreview: React.FC<{ skin: Skin }> = ({ skin }) => {
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <p className="mt-2 text-gray-300 text-xs">Board Skin</p>
        </div>
    );
};
        ...
        <div className="w-full max-w-5xl mx-auto space-y-3 md:space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                ...
                <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-3 flex flex-col space-y-2.5 h-full shadow-lg">
                    ...
                    <div className="grid grid-cols-3 text-center bg-slate-900/50 p-1 rounded-md">
                        <div>
                            ...
                            <p className="text-[9px] text-gray-400">WINS</p>
                        </div>
                        <div>
                            <p className="text-base md:text-lg font-bold text-red-400">{losses}</p>
                            <p className="text-[9px] text-gray-400">LOSSES</p>
                        </div>
                        <div>
                ...
                <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-3 flex flex-col justify-between items-center text-center shadow-lg h-full">
                    <span className="text-[10px] font-bold text-gray-400 tracking-widest">FEATURED ITEM</span>
                    {featuredItem ? (
                        <>
                            <div className="my-2 flex-grow flex flex-col items-center justify-center">
                                ...
                                <p className="text-gray-400 text-[10px] mb-2">Limited Edition Board Skin</p>
                        ...
                        <div className="my-2 text-gray-400">No items in shop.</div>
                    )}
                </div>

                {/* Action Buttons */}
                <div className="grid grid-cols-2 grid-rows-2 gap-3 md:gap-4 h-full">
                    <button onClick={onGoToShop} className="bg-gradient-to-br from-purple-600 to-indigo-600 rounded-xl flex flex-col items-center justify-center space-y-1 font-bold text-sm hover:from-purple-500 transition-all duration-300 transform hover:scale-105 shadow-lg"><ShopIcon /><span>Shop</span></button>
                    <button onClick={onGoToInventory} className="bg-gradient-to-br from-teal-500 to-cyan-500 rounded-xl flex flex-col items-center justify-center space-y-1 font-bold text-sm hover:from-teal-400 transition-all duration-300 transform hover:scale-105 shadow-lg"><InventoryIcon /><span>Inventory</span></button>
                    <button onClick={onOpenSettings} className="bg-slate-700 rounded-xl flex flex-col items-center justify-center space-y-1 font-semibold text-sm hover:bg-slate-600 transition-colors shadow-lg"><SettingsIcon /><span>Settings</span></button>
                    <button className="bg-slate-700 rounded-xl flex flex-col items-center justify-center space-y-1 font-semibold cursor-not-allowed opacity-50 shadow-lg text-sm"><GlobeIcon /><span>Play Online</span></button>
                </div>
            </div>

            <div>
                <h2 className="text-lg md:text-xl font-bold mb-3 text-center mt-3 md:mt-4">Choose Your Opponent</h2>
                <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
                    <div className="bg-[#1E293B] p-3 rounded-xl flex flex-col items-center text-center border border-gray-700 transform hover:scale-105 hover:border-cyan-400 transition-all duration-300">
                        ...
                        <p className="text-gray-400 mt-1 mb-3 h-12 text-xs">A cute little cat new to the game. Perfect for those who don't like challenges.</p>
                        <button onClick={() => onStartGame('easy')} className="w-full bg-cyan-500 text-black py-1.5 rounded-lg font-bold text-sm hover:bg-cyan-400 transition-colors">Challenge</button>
                    </div>
                    <div className="bg-[#1E293B] p-3 rounded-xl flex flex-col items-center text-center border border-gray-700 transform hover:scale-105 hover:border-purple-400 transition-all duration-300">
                        ...
                        <p className="text-gray-400 mt-1 mb-3 h-12 text-xs">A beautiful girl who is a master of strategy. Promises an intellectual date.</p>
                        <button onClick={() => onStartGame('medium')} className="w-full bg-cyan-500 text-black py-1.5 rounded-lg font-bold text-sm hover:bg-cyan-400 transition-colors">Challenge</button>
                    </div>
                    <div className="bg-[#1E293B] p-3 rounded-xl flex flex-col items-center text-center border border-gray-700 transform hover:scale-105 hover:border-red-400 transition-all duration-300">
                        ...
                        <p className="text-gray-400 mt-1 mb-3 h-12 text-xs">A young hacker, thinks carefully before acting, defeat is inevitable.</p>
                        <button onClick={() => onStartGame('hard')} className="w-full bg-cyan-500 text-black py-1.5 rounded-lg font-bold text-sm hover:bg-cyan-400 transition-colors">Challenge</button>
                    </div>
                </div>
            </div>
        </div>
